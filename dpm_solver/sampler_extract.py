...
def model_wrapper(
    ...
    def noise_pred_fn(x, t_continuous, cond=None):
        ...
        if model_type == "noise":
            ...
            print("alpha_t = noise_schedule.marginal_alpha(t_continuous), noise_schedule.marginal_std(t_continuous)", alpha_t)
            print("sigma_t = noise_schedule.marginal_alpha(t_continuous), noise_schedule.marginal_std(t_continuous)", sigma_t)
            print("###################################################################################################################")
            print(x.device)
            print(output.device)
            print(sigma_t.device)
            print(alpha_t.device)
            return (x - alpha_t[:, None, None, None] * output.cpu()) / sigma_t[:, None, None, None]
        elif model_type == "v":
            alpha_t, sigma_t = noise_schedule.marginal_alpha(t_continuous), noise_schedule.marginal_std(t_continuous)
